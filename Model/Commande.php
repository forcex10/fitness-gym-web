...
class Commande {
    ...
    public function __construct($id_commande, $id_client, $date_commande, $status, $prix_commande, $methode, $num, $cvv, $exp, $titulaire, $adresse,$ville,$code_postale,$livraison) {
