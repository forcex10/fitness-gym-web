          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h6 class="card-title">veuillez remplir tous les champs correctement pour ajouter votre post</h6>
                    <form  class="forms-sample" action="" method="POST" id="monFormulaire">
                      ...
                      <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="contenu" name="contenu" rows="50" cols="50" ></textarea>
