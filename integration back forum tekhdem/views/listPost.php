        ...
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <h3 class="card-title"> Liste Des Postes:
              </h3>
              <center>
              <form method="GET" action="addPost.php" style="margin: 0;">
              <input type="hidden" value="<?= $post['idpost']; ?>" name="idpost">
              <button type="submit" class="btn btn-success btn-fw" name="Supprimer">ajouter post</button>
              </form><br>
              <form method="GET" action="search.php" style="margin: 0;">
              <input type="hidden" value="<?= $post['idpost']; ?>" name="idpost">
              <button type="submit" class="btn btn-info btn-fw" name="Supprimer">afficher les commentaires de chaque post</button>
              </form><br>
              ...
              <center>
                ...
                <td>
                    ...
                    <input type="hidden" value="<?= $post['idpost']; ?>" name="idpost">
                    <button type="submit" class="btn btn-warning btn-fw">Commenter</button>
