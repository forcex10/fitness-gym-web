...
if (isset($_POST["nom"]) &&
    isset($_POST["prenom"]) &&
    isset($_POST["email"]) &&
    isset($_POST["contenupost"])) {
    if (!empty($_POST['nom']) &&
        !empty($_POST["prenom"]) &&
        !empty($_POST["email"]) &&
        !empty($_POST["contenupost"]) && validerNom($_POST["nom"]) && validerPrenom($_POST["prenom"]) && validerEmail($_POST["email"])  ) {
        $post = new Post(
            null,
            $_POST['nom'],
            $_POST['prenom'],
...
<body>
    ...
    ?>
        ...
        <table border="0.5" align="center">
                 <tr>
                    <td><label for="idpost">Idpost :</label></td>
                    <td>
                        <input type="text" id="idpost" name="idpost" value="<?php echo $_POST['idpost'] ?>" readonly />
                    </td>
                </tr> 
                <tr>
                    <td><label for="nom">Nom :</label></td>
                    <td>
                        <input type="text" id="nom" name="nom" value="<?php echo $post['nom'] ?>" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="prenom" name="prenom" value="<?php echo $post['prenom'] ?>" />
                ...
                <tr>
                    <td><label for="contenupost">post :</label></td>
                    <td>
                    <textarea id="contenupost" name="contenupost" rows="10" cols="50" required><?php echo isset($post['contenupost']) ? $post['contenupost'] : ''; ?></textarea>

                        <span id="erreurcontenupost" style="color: red"></span>
                    </td>
                </tr>
                <tr>
                    <td>
