...
<style>
    body {
      /* Ajoute ton image de fond et ajuste les propriétés CSS selon tes besoins */
      background-image: url('chemin/vers/ton/image.png');
      background-size: cover; /* Ajuste la taille pour couvrir tout l'écran */
...
<center>
    ...
    <h2>
        <a href="addPost.php">ajouter post</a>
    </h2>
</center>
<table border="1" align="center" width="70%">
    ...
    <?php foreach ($tab as $post) { ?>
        <tr>
            ...
            <td>
                <textarea rows="10" cols="50"><?= $post['contenupost']; ?></textarea>
            </td>
