...
if (isset($_POST["nom"]) &&
    ...
    if (!empty($_POST['nom']) &&
        ...
        $comC->updatecom($com, $_POST['idcom']);
...
<body>
    <button><a href="listCom.php">retour au forum</a></button>
    <hr>
    ...
    if (isset($_POST['idcom'])) {
        $com = $comC->showcom($_POST['idcom']);
    ?>

        <form action="" method="POST" id="monFormulaire">>
        <table border="0.5" align="center">
                 <tr>
                    <td><label for="dcom">Idpost :</label></td>
                    <td>
                        <input type="text" id="idcom" name="idcom" value="<?php echo $_POST['idcom'] ?>" readonly />
                    </td>
                </tr> 
                <tr>
                    <td><label for="nom">Nom :</label></td>
                    <td>
                        <input type="text" id="nom" name="nom" value="<?php echo $com['nom'] ?>" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="prenom" name="prenom" value="<?php echo $com['prenom'] ?>" />
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="email" name="email" value="<?php echo $com['email'] ?>" />
                ...
                <tr>
                    ...
                    <td>
                    <textarea id="contenu" name="contenu" rows="10" cols="50" required><?php echo isset($com['contenu']) ? $com['contenu'] : ''; ?></textarea>
    ...
    <td>
        <input type="file" id="img" name="img" accept="image/*" <?php echo isset($com['img']) ? $com['img'] : ''; ?> />
