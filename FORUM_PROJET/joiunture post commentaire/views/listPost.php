...
<center>
    ...
    <button type="submit" class="btn-hover" name="Supprimer">ajouter post</button>
    </form><br>
    <form method="GET" action="listCom.php" style="margin: 0;">
    <input type="hidden" value="<?= $post['idpost']; ?>" name="idpost">
    <button type="submit" class="btn-hover" name="afficher">afficher commentaires</button>
    </form>
</center>
            ...
            <tr>
                ...
                <td style="border: none;">
                    ...
                    <form method="POST" action="updatePost.php" style="margin-bottom: 5px;">
                        <button type="submit" class="btn-hover" name="Modifier">Modifier</button>
                        <input type="hidden" value="<?= $post['idpost']; ?>" name="idpost">
                    </form>
                    ...
                    <form method="GET" action="deletePost.php" style="margin-bottom: 5px;">
                        <input type="hidden" value="<?= $post['idpost']; ?>" name="idpost">
                        <button type="submit" class="btn-hover" name="Supprimer" >Supprimer</button>
                    </form>
