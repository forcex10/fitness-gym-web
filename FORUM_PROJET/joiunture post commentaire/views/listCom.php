...
<center>
    ...
    <button type="submit" class="btn-hover" name="retour au forum">retour au forum</button>
    </form><br>
    
    <form method="GET" action="addCom.php" style="margin: 0;">
    <input type="hidden" value="<?= $post['idpost']; ?>" name="idpost">
    <button type="submit" class="btn-hover" name="ajouter commentaire">ajouter commentaire</button>
    </form><br>


    <form method="GET" action="search.php" style="margin: 0;">
    <input type="hidden" value="<?= $post['idpost']; ?>" name="idpost">
    <button type="submit" class="btn-hover" name="afficher commentaires par post">afficher commentaires par post</button>
    </form><br>
        ...
        <tr>
            ...
            <td align="center" style="border: none;">
                <form method="GET" action="updateCom.php">
                    <button type="submit" class="btn-hover" style="padding: 5px 10px; background-color: #ff0000; color: #fff; border: none; cursor: pointer;">modifier</button>
            ...
            <td style="border: none;">
                <form method="GET" action="deleteCom.php" style="margin: 0;">
                    <input type="hidden" value="<?= $com['idcom']; ?>" name="idcom">
                    <button type="submit" class="btn-hover" style="padding: 5px 10px; background-color: #ff0000; color: #fff; border: none; cursor: pointer;">supprimer</button>
                </form>
            </td>
             <!--<td style="border: none;"> 
             <form method="GET" action="updateCom.php" style="margin-bottom: 5px;">
                    <input type="hidden" value="<?= $post['idcom']; ?>" name="idpost">
                    <button type="submit" class="btn-hover">Commenter</button>
