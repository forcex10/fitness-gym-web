<?php
    ...
    //Recipients
    $mail->setFrom('rayanferjani55@gmail.com', 'Rayan');
    $mail->addAddress('ferjani.medrayen@esprit.tn');     //Add a recipient            
...
if (isset($list) && !empty($list)) {
    ...
    $bb .= "<div class='total-section'>
        ...
        <a href='http://localhost/fitness-gym-web/View/Frontoffice/verifierCommande.php?id_commande=$id' class='btn btn-danger btn-fw'> Confirmer </a> 
    </div>";
} else {
...
$mail->Body = $bb;
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        if(isset($_POST['submit']) ) {
            ...
            $commande=new Commande(null,$id_client,$heureActuelle,"NoConfirm",$_POST['prix_commande'],$_POST['methode_paiement'],$_POST['num'],$_POST['cvv'],$_POST['exp'],$_POST['titulaire'],$_POST['adresse'],$_POST['ville'],$_POST['code_postal'],$_POST['methode_livraison']);
