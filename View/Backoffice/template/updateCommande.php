<?php
 ...
 if($_SERVER["REQUEST_METHOD"]=="POST"){
     if(isset($_POST['submit']) ) {
         $commande=new Commande(null,$_POST['id_client'],$_POST['date_commande'],$_POST['status'],$_POST['prix_commande'],$_POST['methode_paiement'],$_POST['num'],$_POST['cvv'],$_POST['exp'],$_POST['titulaire'],$_POST['adresse'],$_POST['ville'],$_POST['code_postal'],$_POST['methode_livraison']);
...
<body class="">
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div class="sidebar-brand-wrapper d-sur_place d-lg-flex align-items-center justify-content-center fixed-top">
      ...
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="true" aria-controls="ui-basic">
            ...
            <span class="menu-title">Gestion statuss
</span>
            <i class="menu-arrow"></i>
          </a>
          <div class="collapse" id="ui-basic" style="">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="pages/ui-features/buttons.html">statuss</a></li>
              <li class="nav-item"> <a class="nav-link" href="pages/ui-features/dropdowns.html">Categorie statuss</a></li>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                <div class="navbar-profile">
                  <img class="img-xs rounded-circle" src="assets/images/faces/face15.jpg" alt="">
                  <p class="mb-0 d-sur_place d-sm-block navbar-profile-name">Henry Klein</p>
                  <i class="mdi mdi-menu-down d-sur_place d-sm-block"></i>
                </div>
              </a>
        ...
        ?>
            ...
            <div class="col-md-6 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="listeCommande.php" class="btn btn-dark">Annuler </a>
                        </form>
                    </div>
                    </div>
                </div>
