    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title" align="center">Liste des Commandes</h4>
                        <center>
                        <br/>
                        ...
                        <tbody>
                            <?php foreach ($list as $p): ?>
                                <tr>
                                    ...
                                    <td><?php echo $p['date_commande']; ?></td>
                                    <td><?php echo $p['status']; ?></td>
                                    <td><?php echo $p['prix_commande']; ?></td>
                                    <td><?php echo $p['methode']; ?></td>
                                    <td><?php echo $p['ville'].' '. $p['code_postale'] .' '. $p['adresse']  ; ?></td>
                                    <td><?php echo $p['livraison']; ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <form method="POST" action="updateCommande1.php"  onsubmit="return confirmDistribution('<?php echo $p['status']; ?>')">
                                            <input type="submit" name="update" class="btn btn-primary btn-fw" value="DISTRIBUER">
                                            <input type="hidden" value=<?PHP echo $p['id_commande']; ?> name="id_commande" id='id_commande'>
                                        </form>
                                    </td>
                                    <td> <a href="deleteCommande.php?id_commande=<?php echo $p['id_commande']?>" class="btn btn-danger btn-fw" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette commande ? ')"> DELETE </a> </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                        </table>
