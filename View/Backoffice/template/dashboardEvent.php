...
<div class="collapse" id="produit" style="">
   ...
   <i class="menu-arrow"></i>
          ...
          <div class="collapse" id="evennement" style="">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="http://localhost/fitness-gym-web/View/Backoffice/listeEvent.php">Evennements</a></li>
          
        </ul></div>
<div class="collapse" id="evennement" style="">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="http://localhost/fitness-gym-web/View/Backoffice/listeType_event.php">Type Evennements</a></li>
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <h2><a href="addEvent.php" target="_blank">ajouter un Evennement</a></h2>              
