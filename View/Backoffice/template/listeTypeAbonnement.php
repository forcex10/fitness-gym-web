    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title" align="center">Liste des Types Abonnement</h4>
                        <center>
                        <a href="addTypeAbonnement.php" class="btn btn-success btn-fw" >Ajouter un Type D'Abonnement</a></center>
                        <br/>
                        ...
                        <tbody>
                            <?php foreach ($list as $abonnement): ?>
                                <tr>
                                    ...
                                    <td> <a href="deleteTypeAbonnement.php?id_type_abo=<?php echo $abonnement['id_type_abo']?>" class="btn btn-danger btn-fw" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce type abonnement ? (tous les abonnement liée a ce type seront aussi suprrimer)')"> DELETE </a> </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                        </table>
