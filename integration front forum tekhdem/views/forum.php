...
<meta data-intl-tel-input-cdn-path="intlTelInput/"><style type="text/css" id="operaUserStyle"> 
.erreur {
  color: red;
  font-size: 12px;
}
      ...
      <form id="monFormulaire">
        <table>
          <tr>
            ...
            <td><input type="text" id="nom" name="nom" required title="Veuillez entrer un nom valide (lettres uniquement)" ></td>
            <td id="nomErreur" class="erreur"></td>
          </tr>
          <tr>
            <td><label for="prenom">Prénom :</label></td>
            <td><input type="text" id="prenom" name="prenom" required title="Veuillez entrer un prénom valide (lettres uniquement)" ></td>
            <td id="prenomErreur" class="erreur"></td>
          </tr>
          <tr>
            <td><label for="email">Email :</label></td>
            <td><input type="email" id="email" name="email" required title="Veuillez entrer une adresse mail valide" /></td>
            <td id="emailErreur" class="erreur"></td>
          </tr>          
        </table>
