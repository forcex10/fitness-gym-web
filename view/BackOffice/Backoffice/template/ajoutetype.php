...
/*if(validerNom($_POST["productname"]) && validerDescription($_POST["productdescription"]) && validerNom($_POST["productname"]) && validerPrix( $_POST["productprice"],1000) && validerQuantite($_POST["productstock"], 1000)  ){*/
        ...
        header('Location:ajoutetype.php');
    } else
        $error = "Missing information";
}
$tab=$typeC->listnotificationtype();
    ...
    <a href="tabletype.php"  class="btn btn-info btn-fw" >Back to list </a>
                    ...
                    <form class="forms-sample"  action="" method="POST" >
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control text-light"  id="typename" placeholder="Name"  name="typename"   >
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control text-light"  name="typedescription"       id="typedescription" rows="8"></textarea>
                      ...
                      <input type="submit" id="saveButton1" class="btn btn-outline-primary btn-fw" value="Save" onclick=" saveChanges()"   >
