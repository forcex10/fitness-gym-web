...
if (envoie_mail('activitargym@gmail.com', $_POST['idcom'], 'Avertissment', 'Le commentaire que vous avez ajouter au forum contient du contenu inapproprié. Merci de respecter les règles du forum. Si cette situation persiste, une action pourrait être prise')) {
