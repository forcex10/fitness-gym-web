      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-warning" align="center">Liste des Abonnement</h4>
                        <center>
                        <a href="addAbonnement.php" class="btn btn-success btn-fw" >Add Abonnement</a></center>
                        <br/>
                        <div class="table-responsive">
                          ...
                          <thead>
                            <tr>
                                <th class="text-info">Id Abonnement</th>
                                <th class="text-info">Username</th>
                                <th class="text-info">Cour</th>
                                <th class="text-info">Type</th>
                                <th class="text-info">methode</th>
                            </tr>
                          </thead>
                          <tbody>
                            <?php foreach ($list as $abonnement): ?>
                                <tr>
                                    <td class="text-light"><?php echo $abonnement['Id_abonnement']; ?></td>
                                    <td class="text-light"><?php echo $abonnement['username']; ?></td>
                                    <td class="text-light"> <?php $cour=$courC->showCours($abonnement['cour']) ;
                                                echo $cour['nom'].'('.' Niveau : ' . $cour['niveau'] .')' ;?></td>
                                    <td class="text-light"><?php $typeabo=$TypeAbonnementC->showTypeAbonnement($abonnement['id_type_abo']) ;
                                                echo $typeabo['nom'].' ( '.$typeabo['duree'] . ' mois ' . $typeabo['prix'] .' DT )' ;?></td>
                                    <td class="text-light"><?php echo $abonnement['methode']; ?></td>
                                    <td>
                                    ...
                                    <td> <a href="deleteAbonnement.php?Id_Abonnement=<?php echo $abonnement['Id_abonnement']?>" class="btn btn-danger btn-fw" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet abonnement ?')"> DELETE </a> </td>
                                </tr>
                            <?php endforeach; ?>
                          </tbody>
                            </table>
            ...
            <div class="col-md-6 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Recherche D'Abonnement Par Type</h4>
                        <br/>
                        ...
                        <button type="submit" value="Rechercher" name="search" class="btn btn-primary me-2"> Rechercher </button>
                        </form>
                    </div>
                    </div>
                </div></center>
            <?php
                    if (isset($liste)) {
                        if (count($liste) > 0) {
                            ?>
                            <h2 class="text-success">Résultats de la recherche</h2>
                            <div class="table-responsive">
                          <table class="table table-dark">
                          <thead>
                            <tr >
                                <th class="text-light">Id Abonnement</th>
                                <th class="text-light">Username</th>
                                <th class="text-light">Cour</th>
                                <th class="text-light">methode</th>
                            </tr>
                          </thead>
                          <tbody>
                            <?php foreach ($liste as $abonnement): ?>
                                <tr>
                            ...
                            echo '<h2 class="text-danger">Aucun abonnement trouvé pour ce type.</h2>';
                        }
                    }
                ?>
        </div>
