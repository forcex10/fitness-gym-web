            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <h2 class="text-warning" class="card-title"  ><center>Ajouter Evénements</center></h2>
                                    ...
                                    <body>
                                      <br><br>
                                        ...
                                        <form action="" method="POST" class="forms-sample" enctype="multipart/form-data">
                                            ...
                                            <br><br>
                                            <div class="form-group">
                                                <label for="image" class="text-info" class="image" >Poster:</label>
                                           ...
                                           <center> <input type="submit" value="Save" class="btn btn-outline-primary btn-icon-text">
