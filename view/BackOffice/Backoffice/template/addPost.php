...
if (
    ...
    if (
        ...
        $post = new Post(
            ...
            $_POST['contenu'],
            $_POST['img'],
            $date // Utiliser la date actuelle
        );
        $postC->addpost($post);
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h6 class="card-title" class="text-info">veuillez remplir tous les champs correctement pour ajouter votre post</h6>
                    <form  class="forms-sample" action="" method="POST" id="monFormulaire">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="email" class="form-control text-light"  name="email" value= "<?php echo $_SESSION['email'];?>" />
