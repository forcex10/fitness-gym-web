        ...
        <div class="row ">
          <div class="col-12 grid-margin">
           <div class="card">
                  <div class="card-body">
                  <center>
                  <h1> <small class="text-warning"> Cours </small>
                      </h1>
                    ...
                    <div class="table-responsive">
                      ...
                      <?php
                         ...
                         $cour = $courC->showCours($_POST['idCour']);
                           ?>
                    <form  action="" class="forms-sample" method="POST" id="coursForm"  enctype="multipart/form-data">
                   <input   type="hidden"   name="size"  value="1000000"    >
                   <div class="form-group">
                   <label for="exampleSelectGender" class="text-info">ID Cour </label>
                   
                        <input type="text" id="id" class="form-control text-light required" style="color: white; background:#2c2e33;"  name="idCour"  value="<?php echo $_POST['idCour'] ?>" readonly />
                        </div>
                        ...
                        <div class="form-group">
                    <label for="exampleSelectGender" class="text-info">Nom du cour </label>
                   
                        <input type="text" class="form-control text-light required" id="nomCours" name="nom" required value="<?php echo $cour['nom'] ?>"/>
                        <span id="erreurNom" style="color: red"></span>
                        </div>
                    
                        <div class="form-group">
                    <label for="descCours" class="text-info">Description du cours:</label>        
                    
                         <textarea id="descCours" class="form-control text-light required" name="description" rows="4" required class="aaa"><?php echo $cour['description']; ?></textarea>
                         <span id="erreurDescours" style="color: red"></span>
                        
                     </div>

                     <div class="form-group">
                     <label for="horaire"  class="text-info">Niveau:</label>
                     
                        <select type="text" name="niveau" id="horaires" style="color: white;" class="form-control text-light"  required value="<?php echo $cour['niveau'] ?>" >
                     ...
                     <div class="form-group">
                     <label for="nom_type" class="text-info">choisir un type :</label>

                     <select name="nom_type"  style="color: white;" id="nom_type"  class="form-control text-light">
                  ...
                  <div class="form-group">
                  <input type="file" id="image" class="btn btn-primary me-2" name="image" required>
                  </div>
                      <input type="submit" value="Save" class="btn btn-outline-primary btn-fw" name="save">
