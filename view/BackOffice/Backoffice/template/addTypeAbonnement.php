      ...
      <div class="main-panel">
        ...
        <center>
            <div class="col-md-6 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Ajout Type D'Abonnement</h4>
                        <br/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="text" class="form-control text-light" id="nom" name="nom" placeholder="nom">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="text" class="form-control text-light" id="duree" name="duree" placeholder="duree">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="text" class="form-control text-light" id="prix" name="prix" placeholder="prix">
                            <label id="erreur_prix" class="text-danger"></label>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-outline-primary btn-fw"> Ajouter </button>
                        <a href="listeTypeAbonnement.php" class="btn btn-outline-danger btn-fw">Annuler </a>
                        </form>
                    </div>
                    </div>
                </div><center>
