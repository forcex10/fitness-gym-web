...
<div class="collapse" id="forum" style="">
      ...
      <div class="main-panel">
        ...
        <div class="card">
                  <div class="card-body">
                  <center>
                  <center><h2 class="text-warning"> Types</h2></center>
                      </h1>
                      <a href="tabletype.php"  class="btn btn-info btn-fw" >Back to list </a>
    </h1>
</center>
<?php
    ...
    ?>
                    ...
                    <input type="hidden"  id="idtype" name="idtype"    value="<?php echo $_POST['idtype'] ?>"       />




                        <label for="exampleInputName1" class="text-info">Nom_type :</label>
                      <div class="form-group">
                       
                        <input type="text" class="form-control text-light" id="typename" placeholder="Name"  name="typename" value="<?php echo $type['nomtype'] ?>"  >
                        <span id="erreurnomtype"  class="erreurtype" style="color: red"></span>
                      </div>
                      <label for="exampleTextarea1" class="text-info">Description_type :</label>
                      <div class="form-group">
                      
                        <textarea class="form-control text-light" id="typedescription" name="typedescription"  rows="8"><?php echo $type['descriptiontype'] ?></textarea>
                      ...
                      <input type="submit" id="saveButton1" class="btn btn-outline-primary btn-fw" value="Update"   >
                      <input type="reset" id="resetButton1"
                      class="btn btn-outline-warning btn-fw" value="Reset" onclick="effacerMessagesErreurtype()">

                    
                    <button type="button" id="bouton1"   class="btn btn-outline-info btn-fw"  >Verifier</button></td>
