        ...
        <div class="row ">
          <div class="col-12 grid-margin">
           <div class="card">
                  <div class="card-body">
                  <center>
                  <h2 class="card-title"><i class="text-warning">Type Cours</i></h2>
                ...
                <div class="table-responsive">
                    ...
                    <label for="nomCours" class="text-info">Nom du type cours:</label>
                    <div class="form-group">
                       <input type="text" id="nomCours" style="color:white" name="typenom" class="form-control text-light required"  style="width: 80%">
                    ...
                    <label for="descCours" class="text-info">Description du cours:</label>
                        ...
                        <textarea id="descCours" style="color:white" class="form-control text-light"  name="typedescription" rows="4"  class="aaa"></textarea>
                        <span id="erreurDescours" class="error-message" style="color: red"></span>
                      </div>

                      <div class="form-group">
                      <input type="submit" id="but-ajt"class="btn btn-outline-primary btn-fw" value="Save"    >
