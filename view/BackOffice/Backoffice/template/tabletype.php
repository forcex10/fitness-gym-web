    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="card">
                  <div class="card-body">
                  <center>
                  <center><h2 class="text-warning">Liste Types</h2></center>
                      </h1>
                      <br> <br>
                      <br> <br>
    <form method="GET">
        
        <button class="btn btn-outline-primary btn-fw"  type="submit" name="sortPrice">Trier</button>
        <input  class="btn btn-outline-dark btn-fw text-light"    type="text" id="searchh" name="searchh" placeholder="search" value="<?php echo isset($_GET['searchh']) ? $_GET['searchh'] : ''; ?>">
        <input  type="submit" value="Search"    class="btn btn-outline-warning btn-fw"  >
    </form>
    <h2>
        <a  class="btn btn-info btn-fw"         href="ajoutetype.php" class="text-light">Add type</a>
    </h2>
</center>
                    <div class="table-responsive">
                      <table class="table table-hover">
                        <thead>
                        <tr>
        <th class="text-info">Id type</th>
        <th class="text-info">Nom_type</th>
        <th class="text-info">Desciption_type</th>
        ...
        ?>
                          <tr>
                          <td class="text-light"><?= $type['idtype']; ?></td>
                          <td class="text-light"><?= $type['nomtype']; ?></td>
                          <td class="text-light"><?= $type['descriptiontype']; ?></td>
        ...
        <td align="center">
            ...
            <td>
                <a  class="btn btn-outline-danger btn-fw"             href="supprimertype.php?id=<?php echo $type['idtype']; ?>" >Delete</a>
            </td>
        </tr>
        <?php
        }
