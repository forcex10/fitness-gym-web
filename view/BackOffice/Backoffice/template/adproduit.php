...
if (
    ...
    if (
        ...
        validerNom($_POST["productname"]) &&
        validerDescription($_POST["productdescription"]) &&
        validerPrix($_POST["productprice"], 1000) &&
        validerQuantite($_POST["productstock"], 1000)
    ) {
        $image = $_FILES['image']['name'];
        $produit = new produit(
            null,
        ...
        $produitC->addproduit($produit);
          ...
          echo "Erreur: Impossible de récupérer l'ID du produit.";
      }
        ...
        if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
            ...
            $msg = "There was a problem uploading image" . $_FILES['image']['error'];
        }

        // Marquer l'ajout via la notification dans la variable de session
       
        header('Location:adproduit.php');
        exit;
    ...
    <a href="produit.php"   class="btn btn-info btn-fw" >Back to list </a>
        ...
        <?php } ?>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control text-light" id="exampleInputName1" placeholder="Name"  name="productname"  >
                        <span id="erreurnom" class="erreur" style="color: red"></span>
                      </div>
                      <label for="exampleTextarea1 " class="text-info">Description</label>
                      <div class="form-group">
                      
                        <textarea class="form-control text-light"  name="productdescription"    id="exampleTextarea1" rows="8"></textarea>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control text-light" id="exampleInputMobile" placeholder="Prix"     name="productprice">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control text-light" id="exampleInputMobilee" placeholder="Quantite"    name="productstock">
                      ...
                      <input type="submit" id="saveButton" class="btn btn-outline-primary btn-fw" value="Save" name="save" onclick="saveChanges()"   >
