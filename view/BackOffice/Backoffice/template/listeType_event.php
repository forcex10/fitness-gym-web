        ...
        <div class="content-wrapper">
          ...
          <div class="row ">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                <h4 class="card-title"><i class="text-danger">Type Evénements</i></h4>
                  <div class="table-responsive">
                  <body>
                  <center><h2 class="text-warning">Liste Types Evénements</h2></center>
                  <center><button class="btn btn-info btn-fw"><a href="addType_event.php" class="text-light">Ajouter Type Evénements</a></button></center> 
                    <br><br>
                    <br><br>
                    <table class="table table-hover">
                        <tr>
                            <th class="text-info">Id TypeEvénement</th>
                        ...
                        ?>
                            <tr>
                            <td class="text-light"><?php echo $type_event['idtype_event'] ?> </td>
                            <td class="text-light"><?php echo $type_event['nom'] ?> </td>
                            <td align="center">
