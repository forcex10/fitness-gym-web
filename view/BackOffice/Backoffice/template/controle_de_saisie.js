...
document.getElementById("contenu").addEventListener("keyup", function () {
  ...
  var contenuErreur = document.getElementById("erreurContenu");

  var contenuValide = !/(fuck|shit|merde|bordel)/i.test(contenu);

  if (contenuValide) {
    contenuErreur.textContent = "Contenu valide";
    contenuErreur.style.color = "green";
  } else {
    contenuErreur.textContent = "Le contenu ne peut pas contenir de gros mots";
    contenuErreur.style.color = "red";
  }
});
