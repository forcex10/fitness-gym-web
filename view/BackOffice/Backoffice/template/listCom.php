...
.options-buttons {
  ...
  /* Autres styles pour les boutons */
        ...
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <center><h2 class="text-warning">Liste commentaires</h2></center><br>
              </h3>
              <center>
              </form><br>
              ...
              <center>
                      <table>
                        <thead>
                          ...
                          <th class="text-info">commentaire </th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?= $com['date']; ?></td>
                            <td>
                              <textarea class="post-textarea" readonly><?= $com['contenu']; ?></textarea>
                            </td>

                            <td>
                              <img src="<?= $com['img']; ?>" alt="pas d'image" class="post-image" />
                          </td>
                ...
                <td>
                  <?php if($_SESSION['email']==$com['email']){?>
                    <!-- Bouton "Modifier" -->
                  ...
                  <?php ; }?>
                    ...
                    <!-- Bouton "Supprimer" -->
                    <form method="GET" action="deleteCom.php" style="margin-bottom: 5px;">
                    <input type="hidden" value="<?= $com['idcom']; ?>" name="idcom">
    ...
    <!-- Bouton "Signaler" -->
   <!-- Bouton "Signaler" -->
<form method="POST" action="signalcom.php" style="margin-bottom: 5px;">
    <input type="hidden" value="<?= $com['email']; ?>" name="idcom">
