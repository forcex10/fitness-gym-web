...
include_once "../../../../model/type_cour.php";
$error = "";
...
if (
    ...
    if (
        ...
        header('Location:listtypecouri.php');
    } else
        ...
        <div class="row ">
          <div class="col-12 grid-margin">
           <div class="card">
                  ...
                  <div class="card-body">
                  <center>
                  <h1> <small class="text-warning">Type  cour </small>
                      </h1>
                      <center><button class="btn btn-info btn-fw"><a class="text-light" href="listtypecouri.php">Back to list</a></button></center>
                ...
                <div class="form-group">
                   ...
                   <input type="text" class="form-control" style="color: white; background:#2c2e33;" id="id" name="id" value="<?php echo $_POST['id'] ?>" readonly />
                   </div>
                   ...
                   <div class="form-group">
                    <label for="exampleSelectGender" class="text-info">Nom du type cour</label>
                    
                        <input type="text" id="nomCours" class="form-control text-light required" id="nomCours" name="typenom" required value="<?php echo $courType['nom_type'] ?>"/>
                        <span id="erreurNom" style="color: red"></span>
                        
                     </div>
                     <div class="form-group">
                    <label for="descCours" class="text-info">Description de type du cours:</label>        
                    
                          <textarea id="descCours" class="form-control text-light required" id="nomCours" name="typedescription" rows="4" required class="aaa"><?php echo $courType['description_type']; ?></textarea>
...
<script src="courstylejs.js"></script>
