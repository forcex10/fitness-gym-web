        ...
        <div class="content-wrapper">
          ...
          <div class="row ">
            <div class="col-12 grid-margin">
              ...
              <div class="card-body">
                <h2 class="text-warning" class="card-title">Ajouter Type Evénements</h2>
                <center><button class="btn btn-info btn-fw"><a class="text-light" href="listeType_event.php">Back to list</a></button></center>
                  ...
                  <form action="" method="POST" class="forms-sample">
                    <div class="form-group row">
                                  <label for="nom" class="text-info" class="col-sm-3 col-form-label" class="text-light">Nom:</label>
                                  ...
                                  <input type="submit" value="Save" class="btn btn-outline-primary btn-icon-text">
