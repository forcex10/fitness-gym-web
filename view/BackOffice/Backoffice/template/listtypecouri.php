        ...
        <div class="content-wrapper">
          ...
          <div class="row ">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"><i class="text-danger">Our Type Courses</i></h4>
                  <div class="table-responsive">
                      
                  <center>
                     <h1 class="text-warning">List of Type Courses</h1>
                     
                         <h2>
                        <a class="btn btn-success"  href="addtypecouri.php">Add Types</a>
                        </h2> 
                  </center>
                ...
                <table class="table table-hover">
                 ...
                 <?php foreach ($tab as $courType) { ?>
                    ...
                    <td class="text-light"><?= $courType['id']; ?></td>
                    <td class="text-light"><?= $courType['nom_type']; ?></td>
                     <td class="text-light"><?= $courType['description_type']; ?></td>
                     <td align="center">
                    <form method="POST" action="updatetypecouri.php">
                ...
                <td>
                    <a href="deletetypecouri.php?id=<?= $courType['id']; ?>"  class="btn btn-outline-danger btn-fw">Delete</a>
                </td>
                <?php } ?>
                 </div>
                 </tbody>
