              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <body>
                    <center><h2 class="text-warning">Liste Evénements</h2></center>
                    <center><button class="btn btn-info btn-fw"><a href="addEvent.php"class="text-light">Ajouter Evénements</a></button></center>  
                    <br><br> 
                    <br><br>           
                      <table  class="table table-hover">
                          <tr>
                              <th class="text-info">Id Evénement</th>
                              <th class="text-info">Nom</th>
                              <th  class="text-info">Localisation</th>
                              <th class="text-info">date</th>
                              <th class="text-info">Horaire</th>
                              <th class="text-info">Description</th>
                              <th class="text-info">Type</th>
                              <th class="text-info">Poster</th>
                              <th class="text-info">Latitude</th>
                              <th class="text-info">Longitude</th>
                          ...
                          <?php
                            ...
                            ?>
                                <tr>
                                    <td class="text-light"><?php echo $event['idevent'] ?> </td>
                                    <td class="text-light"><?php echo $event['nom'] ?> </td>
                                    <td class="text-light"><?php echo $event['local'] ?></td>
                                    <td class="text-light"><?php echo $event['date'] ?></td>
                                    <td class="text-light"><?php echo $event['temps'] ?></td>
                                    <td class="text-light"><?php echo $event['description'] ?></td>
                                    <td class="text-light">
                                        <?php
                                    ...
                                    <td class="text-light"><?php echo $event['lat'] ?></td>
                                    <td class="text-light"><?php echo $event['lng'] ?></td>
                      ...
                      <hr>
                          <form action="" method="POST" class="forms-sample">
                           <div class="form-group">
                              <h3 class="text-warning"><center>Chercher Evénements</center></h3>
                              <br><br>
                              ...
                              <center><input type="submit" value="Rechercher" name="search" class="btn btn-outline-info btn-fw"></center>
                          </form>
                  
                          <?php if (isset($list)) { ?>
                            <br><br>
                      <a  class="text-warning">Événements correspondants au type sélectionné :</a>
                      <br></br>
                      <br><br>
