...
include_once "C:/xampp/htdocs/fitness-gym-web/Controller/coursC.php";
session_start();
$error = "";
      ...
      <div class="main-panel">
        ...
        ?>
            ...
            <div class="col-md-6 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Mise A Jour Abonnement</h4>
                        <br/>
                        <form class="forms-sample" action="" method="POST" onsubmit="return validerFormulaire()">
                        <div class="form-group row">
                            <label for="id_abonnement" class="col-sm-3 col-form-label" >Id_Abonnement</label>
                            <div class="col-sm-9  ">
                            <input type="text" class="form-control text-light" id="id_abonnement" name="id_abonnement" value="<?php echo $_POST['id_abonnement'] ?>" readonly >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="username" class="col-sm-3 col-form-label" >Username</label>
                            <div class="col-sm-9">
                            <input type="text" class="form-control text-light" id="username" name="username" placeholder="Username" value="<?php echo $abonnement['username'] ;?>" >
                        ...
                        <div class="form-group row">
                            ...
                            <?php
                                foreach($cours as $c){
                                    ...
                                    echo ($abonnement['cour'] === $c['id']) ? ' selected' : '';
                                    echo '>' .$c['nom'].'('.' Niveau : ' . $c['niveau'] .')' ;
                                }
                            ?>
                            </select>
                            </div>
                        ...
                        <div class="form-group row champ_carte" id="champ_cb" >
                            ...
                            <div class="col-sm-9">
                            <input type="text" id="num_cb" name="num_cb"  class="form-control text-light" value="<?php echo  $abonnement['num_cb'] ?>" />
                            <br/>
                            ...
                            <div class="col-sm-9">
                            <input type="text" id="titulaire_cb" name="titulaire_cb"  class="form-control text-light" value="<?php echo  $abonnement['titulaire_cb'] ?>" />
                            <br/>
                            ...
                            <div class="col-sm-9">
                            <input type="text" id="exp_cb" name="exp_cb"  class="form-control text-light" value="<?php echo  $abonnement['exp_cb'] ?>" />
                            <br/>
                            <label id="erreur_exp_cb"  class="text-danger"></label></div>
                            <label for="cvv_cb" class="col-sm-3 col-form-label">Code CVV :</label>
                            <div class="col-sm-9">
                            <input type="text" id="cvv_cb" name="cvv_cb"  class="form-control text-light" value="<?php echo  $abonnement['cvv_cb'] ?>" />
                            <br/>
                        ...
                        <div class="form-group row champ_carte" id="champ_visa">
                                ...
                                <div class="col-sm-9">
                                <input type="text" id="num_visa" name="num_visa"  class="form-control text-light" value="<?php echo  $abonnement['num_visa'] ?>">
                                <br/>
                                ...
                                <div class="col-sm-9">
                                <input type="text" id="titulaire_visa" name="titulaire_visa"  class="form-control text-light" value="<?php echo  $abonnement['titulaire_visa'] ?>">
                                <br/>
                                ...
                                <div class="col-sm-9">
                                <input type="text" id="exp_visa" name="exp_visa"  class="form-control text-light" value="<?php echo  $abonnement['exp_visa'] ?>">
                                <br/>
                                <label id="erreur_exp_visa"  class="text-danger"></label></div>
                                <label for="cvv_visa" class="col-sm-3 col-form-label">Code CVV  VISA :</label>
                                <div class="col-sm-9">
                                <input type="text" id="cvv_visa" name="cvv_visa"  class="form-control text-light" value="<?php echo  $abonnement['cvv_visa'] ?>">
                                <br/>
                        ...
                        <div class="form-group row champ_carte" id="champ_mc">
                                ...
                                <div class="col-sm-9">
                                <input type="text" id="num_mc" name="num_mc"  class="form-control text-light" value="<?php echo  $abonnement['num_mc'] ?>">
                                <br/>
                                ...
                                <div class="col-sm-9">
                                <input type="text" id="exp_mc" name="exp_mc"  class="form-control text-light" value="<?php echo  $abonnement['exp_mc'] ?>">
                                <br/>
                                ...
                                <div class="col-sm-9">
                                <input type="text" id="cvv_mc" name="cvv_mc"  class="form-control text-light" value="<?php echo  $abonnement['cvv_mc'] ?>">
                                <br/>
                        ...
                        <div class="form-group row champ_carte" id="champ_edinar">
                                ...
                                <div class="col-sm-9">
                                <input type="text" id="num_edinar" name="num_edinar"  class="form-control text-light" value="<?php echo  $abonnement['num_edinar'] ?>">
                                <br/>
                                ...
                                <div class="col-sm-9">
                                <input type="text" id="code_edinar" name="code_edinar"  class="form-control text-light" value="<?php echo  $abonnement['code_edinar'] ?>">
                                <br/>
                                <label id="erreur_code_edinar" class="text-danger"></label></div>
                        </div>
                        <button type="submit" class="btn btn-outline-primary btn-fw"> Save </button>
                        <a href="listeAbonnement.php" class="btn btn-outline-danger btn-fw">Annuler </a>
                        </form>
                    </div>
                    </div>
                </div>
