    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-warning" align="center">Liste Types Abonnements</h4>
                        <center>
                        <a href="addTypeAbonnement.php" class="btn btn-info btn-fw" >Ajouter un Type D'Abonnement</a></center>
                        <br/>
                        ...
                        <thead>
                            <tr >
                                <th class="text-info">Id_Type_Abonnement</th>
                                <th class="text-info">nom</th>
                                <th class="text-info">duree(mois)</th>
                                <th class="text-info">prix(DT)</th>
                        ...
                        <tbody>
                            <?php foreach ($list as $abonnement): ?>
                                <tr>
                                    <td class="text-light"><?php echo $abonnement['id_type_abo']; ?></td>
                                    <td class="text-light"><?php  echo $abonnement['nom']; ?></td>
                                    <td class="text-light"><?php echo $abonnement['duree']; ?></td>
                                    <td class="text-light"><?php echo $abonnement['prix']; ?></td>
                                    <td >
                                    ...
                                    <td> <a href="deleteTypeAbonnement.php?id_type_abo=<?php echo $abonnement['id_type_abo']?>" class="btn btn-outline-danger btn-fw" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce type abonnement ? (tous les abonnement liée a ce type seront aussi suprrimer)')"> DELETE </a> </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                        </table>
