    ...
    <a href="listetype.php">Back to list </a>
        ...
        <table>
            <tr>
                ...
                <td>
                <input type="text" id="typename" name="typename" required placeholder="nom">
            ...
            <tr>
                ...
                <td>
                <textarea  id="typedescription" name="typedescription" required placeholder="description">  </textarea>
