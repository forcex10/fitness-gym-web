...
if (isset($_POST["nom"]) &&
    ...
    // Récupération du commentaire existant avec la date
    $com = $comC->showcom2($_POST['idcom']);
    ...
    if (!empty($_POST['nom']) &&
        ...
        // Récupérer l'ID du post associé au commentaire modifié
        $postId = $comC->getPostIdByCommentId($_POST['idcom']);

        // Rediriger vers la page listCom.php avec l'ID du post
        header("Location: listCom.php?idpost=$postId");
        exit;
    } else {
...
<body>
    ...
    ?>
                    <li><a href="listPost.php">retour a la liste des postes</a></li><br><br>
                        ...
                        <span id="erreurPrenom" style="color: red"></span>
                                ...
                                <div class="col-lg-4">
                                <input type="hidden" name="idcom" id="idcom"  value="<?php echo $com['idcom']; ?>">
                                </div>
                                <div class="col-lg-12">
