...
// Vérifier si l'ID du post est présent dans l'URL
    ...
    // Récupérer les commentaires associés à l'ID du post spécifique
    $tab = $c->getCommentsByPostID($idpost);

    $postOwner = $c->getPostOwnerName($idpost);
    $postNom = $postOwner['nom'];
    $postPrenom = $postOwner['prenom'];
...
<body>
                ...
                <div class="nav-menu">
                    <nav class="mainmenu mobile-menu">
                        ...
                        <li><a href="./index.php">Home</a></li>
                            ...
                            <li class="active"><a href="./listPost.php">Forum</a></li>
    ...
    <h3 style="color: white;">Les commentaires de post de <?= $postNom . ' ' . $postPrenom; ?></h3>
</h3><br><br>
                    </div>
                </div>
            </div>
