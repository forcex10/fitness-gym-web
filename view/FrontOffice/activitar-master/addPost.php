                    ...
                    <li><a href="listPost.php">retour a la liste de postes</a></li><br><br>
                        <form action="" method="POST" id="monFormulaire">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                <input type="text" id="email" placeholder="email" name="email" value="<?php echo $_SESSION['email'];?>" />
                                <span id="erreurEmail" style="color: red"></span>
                                </div>
                                <div class="col-lg-12">
                                <textarea type="text" placeholder="contenu" id="contenu" name="contenu" rows="50" cols="50" ></textarea>
                                <span id="contenuErreur" style="color: red"></span>
                                </div>
                                <div class="col-lg-4">
                        <label for="img"style="color: white">image</label>
                        <input type="file"  id="img" name="img">
                      </div>
                      <input type="hidden" id="currentImg" name="currentImg" value="<?php echo $post['img']; ?>">
                            </div>
