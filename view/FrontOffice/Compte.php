          ...
          <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
            ...
            <a href="activitar-master/index.php"><button type="button" class="btn btn-danger btn-fw">Back</button></a>
              <div class="card-body px-5 py-5">
                ...
                <h3 class="card-title text-left mb-3">Profile</h3>
                <form id="registrationForm" method="post" action="" enctype="multipart/form-data">
                  ...
                  <label for="nom">Nom :</label>
                     <input type="text" id="nom"class="form-control p_input" name="nom" value="<?php echo  $_SESSION['nom'] ?>" />
                    <span class="error-message" id="erreurNom" style="color: red"></span>
                  </div>

                  <div class="form-group"> 
                  <label for="prenom">Prénom :</label>
                    <input type="text" id="prenom" class="form-control p_input" name="prenom" value="<?php echo  $_SESSION['prenom'] ?>" />
                    <span class="error-message" id="erreurPrenom" style="color: red"></span>
                  </div>

                  <div class="form-group"> 
                  <label for="email">Email :</label>
                  <input type="text" id="email" class="form-control p_input" name="email" value="<?php echo  $_SESSION['email'] ?>" />
                    <span class="error-message" id="erreurEmail" style="color: red"></span>
                  </div>

                  <div class="form-group"> 
                  <label for="telephone">Téléphone :</label>
                  <input type="text" id="telephone" class="form-control p_input" name="tel" value="<?php echo  $_SESSION['tel']?>" />
                    <span class="error-message" id="erreurTelephone" style="color: red"></span>
                  </div>
                  
                  <div class="form-group"> 
                  <label for="password">Mot de passe:</label>
                  <input type="password" id="password" class="form-control p_input"  name="password" value="<?php echo  $_SESSION['password']?>" />
